...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isKg = true
        inputwt1.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view,keyCode)}  // To Hide the keyboard after pressing enter on input Text field
    ...
    // Function to Hide Keyboard on pressing Enter
